...
export function BlogArticle({ document }: BlogArticleProps) {
    return (
        <div className="w-full prose prose-lg max-w-none dark:prose-invert prose-code:before:content-[''] prose-code:after:content-[''] prose-headings:my-4 mb-8 prose-p:text-zinc-900 dark:prose-p:text-white">
