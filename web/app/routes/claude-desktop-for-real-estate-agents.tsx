...
export function meta() {
    return generateRouteMeta({
        ...
        descriptionContent: '51-page guide with 12+ real estate workflows, prompt framework, and advanced techniques. Save hours weekly on listings, client communication, and operations.',
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <Card className="p-6 space-y-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-700 dark:text-zinc-300">Master Claude Desktop with step-by-step walkthroughs. Interface navigation, Projects feature, file uploads, and 12+ real estate use cases with proven workflows.</p>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Card className="p-6 space-y-3">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-zinc-700 dark:text-zinc-300">Learn a repeatable prompt framework plus ready-to-use templates for listings, buyer and seller updates, and marketing outreach.</p>
                                    </div>
                                </div>
                            </Card>
                        ...
                        <Card className="p-6">
                            <ul className="space-y-3 text-zinc-700 dark:text-zinc-300">
                                <li className="flex items-start gap-2">
                                    ...
                                    <span>Real estate agents already using Claude Desktop who want to work smarter</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-primary mt-1">✓</span>
                                    <span>Agents looking to save hours per week on routine tasks</span>
                                </li>
                                <li className="flex items-start gap-2">
                                    <span className="text-primary mt-1">✓</span>
                                    <span>Tech-forward Realtors wanting a competitive advantage in their market</span>
                                </li>
                            </ul>
                        </Card>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <Card className="p-4">
                                <ul className="space-y-2 text-zinc-700 dark:text-zinc-300">
                                    ...
                                    <li>• Marketing materials and social posts</li>
                                    <li>• Email templates for buyers and sellers</li>
                        ...
                        <Card className="p-6 bg-gradient-to-br from-primary/10 to-secondary/10 dark:from-primary/20 dark:to-secondary/20 border-primary/30">
                            <ul className="space-y-4 text-zinc-700 dark:text-zinc-300">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>
                                        <strong>Save hours every week</strong> on listing descriptions, client emails, and marketing content
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="font-bold text-primary text-xl">→</span>
                                    <span>
                                        <strong>Professional quality outputs</strong> that match your voice and market expertise
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="font-bold text-primary text-xl">→</span>
                                    <span>
                                        <strong>Proven workflows and prompts</strong> tested by real estate professionals
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="font-bold text-primary text-xl">→</span>
                    ...
                    <div className="md:col-span-1 space-y-4 min-w-0">
                        <section className="rounded-lg bg-zinc-800 p-6 space-y-4 sticky top-4">
                            ...
                            <Linky external to={PRODUCT_LINKS.CLAUDE_REAL_ESTATE_BUNDLE} className="w-full block">
